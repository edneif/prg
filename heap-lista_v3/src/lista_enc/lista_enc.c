...
/**
  ...
  * @param	lista: lista encadeada em questão
  *
  * @retval int: Número de elementos
  */
...
/**
  * @brief  Imprime os ponteiros dos dados inseridos na lista (ordem direta).
  * @param	lista: lista encadeada que se deseja adicionar.
  *
  * @retval Nenhum
  */
...
/**
  * @brief  Imprime os ponteiros dos dados inseridos na lista (ordem reversa)
  * @param	lista: lista encadeada que se deseja adicionar.
  *
  * @retval Nenhum
  */
...
/**
  * @brief  Retornar se a lista está vazia.
  * @param	lista: lista encadeada em questão.
  *
  * @retval int: verdadeiro se vazia, falso caso contrário.
  */
...
/**
  * @brief  Remove a cauda da lista. Não libera o nó.
  * @param	lista: lista encadeada em questão.
  *
...
/**
  * @brief  Remove a cabeça da lista. Não libera o nó.
  * @param	lista: lista encadeada em questão.
  *
  * @retval no_t *: nó removido da lista.
  */
...
/**
  * @brief  Busca e remove um nó específico da lista. Libera o nó.
  * @param	lista: lista encadeada em questão.
  *         no_removido: referência de nó a ser removido
  *
  * @retval void *: ponteiro dos dados do nó removido.
  */
