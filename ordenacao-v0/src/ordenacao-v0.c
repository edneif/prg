...
int main(void) {
	...
	clock_t selectionsort_start = 0, selectionsort_end = 0, selectionsort_total = 0;
...
//	buble_sort(array, tamanho_array);
	...
	printf("\n| Merger Total  | %f",
			(double) mergesort_total / (repeticoes * CLOCKS_PER_SEC));
	...
	printf("\n| Select Total  | %f",
			(double) selectionsort_total / (repeticoes * CLOCKS_PER_SEC));
